...
{
    m_http_client = get_http_client([&](int conn, int status, std::unordered_map<std::string, const char*>& header_kvs,
...
int main(int argc, char *argv[])
{
    ...
    crawler.add_cmd("get", [&](std::vector<std::string>& args, crx::console *c) {
